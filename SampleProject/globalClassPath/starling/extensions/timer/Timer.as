package starling.extensions.timer
{
	...
	public class Timer extends EventDispatcher
	{
		...
		// TODO: A pause() method which, unlike stop(), resumes the current timer loop with its remaining time.
		public function Timer(delay:uint, repeatCount:uint = 0)
		{
			super();
		...
		/** A convenience method, wrapping a reset() and a start(). */
