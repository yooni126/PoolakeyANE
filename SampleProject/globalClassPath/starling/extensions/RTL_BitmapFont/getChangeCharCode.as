...
package starling.extensions.RTL_BitmapFont 
{
	 ...
	 * @author majid
	 */
	public class getChangeCharCode 
	{
		public static const BEGINING_STICKING:String = "beginingSticking";
		...
		public function getChangeCharCode():void
		{
		...
		public static function charCode($text:String):Array
		{
			...
			//{
				...
				//
				//for (var i:int = 0; i < charIdArr.length; i++) 
				//{
					//if (charIdArr[i] == charId)
					//{
						//bool = false;
						//break;
					//}
				...
				//if (bool) 
				//{
					//charIdArr.push(charId);
				//}
			//}
			//
			//charIdArr.sort(1);
			//
			//for (i = 0; i < charIdArr.length; i++) 
			//{
				//trace(charIdArr[i]);
			//}
			//trace("charIdArr:", charIdArr.length)
		...
		private static function location2($text:String, $i:int):String
		{
			...
			else if (nextSticking == 1) loc = BEGINING_STICKING;
			else loc = SEPARATE;
