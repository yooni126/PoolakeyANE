...
// ----------------------------------------------------------------------------------------------------------------------- Properties
		...
		public static function get supportedGestures():Vector.<String>
		{
			Multitouch.inputMode = MultitouchInputMode.GESTURE;
			if (Multitouch.supportedGestures)
				return Multitouch.supportedGestures;
		...
		public static function get dpiScaleMultiplier():Number
		{
			...
			//{
				//multiplier= changeFontSize()
			//}
			if (Capabilities.screenResolutionX >= 1920 && Capabilities.screenResolutionY >=  1200 && currDpi<=240 )
			{
				multiplier = 1.5;
			}
		...
		//public static function changeFontSize():Number
		//{
			//var a:Number = Capabilities.screenResolutionX / 480;
			//var b:Number = Capabilities.screenResolutionY / 800;
			//var c:Number = Capabilities.screenDPI / 240;
			//
