...
package feathers.themes {
    ...
    /**
     * Icons for the "Material CyanLime" theme. These icons are initialized by
     * <code>MaterialCyanLimeMobileThemeWithIcons</code> and <code>MaterialCyanLimeMobileThemeWithAssetManagerAndIcons</code>.
     */
    public class MaterialCyanLimeMobileThemeIcons {
        ...
        public static var playTexture:Texture;
        ...
        internal static function initialize( atlas:TextureAtlas ):void {
            ...
            playTexture = getTextureForIcon(atlas,"play-button-icon");
        }
        ...
        private static function getTextureForIcon( atlas:TextureAtlas, name:String ):Texture {
            ...
            if( !texture ) {
                trace("[MaterialCyanLimeThemeIcons - Warning] Texture for icon '" + name + "' not found.");
            }
            return texture;
        }
